                ...
                <div className="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-100">
                  <div className="px-6 py-4 border-b border-gray-200" style={{ background: `linear-gradient(to right, ${theme.primaryColor}20, ${theme.primaryColor}20)` }}>
                    <h2 className="text-xl font-semibold text-gray-800 flex items-center space-x-2">
                      ...
                      <span>{t('hotelAdmin.settings.sections.hotelLogo', { defaultValue: 'Hotel Logo' })}</span>
                    </h2>
                  </div>
                  <div className="p-8">
                    <div className="space-y-4">
                      <div>
                        <label className="block text-sm font-semibold text-gray-700 mb-2">{t('hotelAdmin.settings.fields.uploadLogo', { defaultValue: 'Upload Logo' })}</label>
                        <input
                          type="file"
                          accept="image/*"
                        ...
                        />
                        <p className="text-xs text-gray-500 mt-2">{t('hotelAdmin.settings.placeholders.uploadLogoHint', { defaultValue: 'Upload a new logo for your hotel (PNG, JPG, or GIF). Leave empty to keep current logo.' })}</p>
                      </div>
                      {logoPreview && (
                        <div className="mt-4">
                          <label className="block text-sm font-semibold text-gray-700 mb-2">
                            {logoFile ? t('hotelAdmin.settings.fields.newLogoPreview', { defaultValue: 'New Logo Preview' }) : t('hotelAdmin.settings.fields.currentHotelLogo', { defaultValue: 'Current Hotel Logo' })}
                          </label>
                          ...
                          <p className="text-xs text-gray-500 mt-2">
                            {logoFile ? t('hotelAdmin.settings.placeholders.newLogoHint', { defaultValue: 'This is how your new logo will look' }) : t('hotelAdmin.settings.placeholders.currentLogoHint', { defaultValue: 'This is your current hotel logo' })}
                          </p>
                        </div>
                      )}
                    </div>
