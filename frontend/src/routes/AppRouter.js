...
const HotelGroupsPage = lazy(() => import('../pages/superadmin/HotelGroupsPage'));
...
const HotelBrandingSettingsPage = lazy(() => import('../pages/hotel/BrandingSettingsPage'));
...
const AppRouter = () => {
  return (
    <Suspense fallback={<LoadingScreen />}>      <Routes>        {/* Public Routes */}
        ...
        />
        <Route
          path="/hotel/performance-analytics"
          element={
            <ProtectedRoute allowedRoles="hotel">
              <TailwindLayout>
                <HotelPerformanceAnalyticsPage />
              </TailwindLayout>
            </ProtectedRoute>
          }
        />
